...
| 09_factorization | B | yes | no | no | `problems/09_factorization/README.md` |
| 10_post_quantum_cryptography | B | yes | no | no | `problems/10_post_quantum_cryptography/README.md` |
| 11_quantum_machine_learning | B | yes | no | no | `problems/11_quantum_machine_learning/README.md` |
