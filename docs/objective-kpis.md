...
|---|---|---|---|---|---|
| 01_hubbard | C | yes | yes | yes | `problems/01_hubbard/README.md` |
...
| 07_drug_discovery | C | yes | yes | yes | `problems/07_drug_discovery/README.md` |
...
| 14_materials_discovery | C | yes | yes | yes | `problems/14_materials_discovery/README.md` |
| 15_database_search | D | yes | yes | yes | `problems/archived/15_database_search/README.md` |
| 16_error_correction | C | yes | yes | yes | `problems/16_error_correction/README.md` |
| 17_nuclear_physics | C | yes | yes | yes | `problems/17_nuclear_physics/README.md` |
| 18_photovoltaics | C | yes | yes | yes | `problems/18_photovoltaics/README.md` |
| 19_quantum_chromodynamics | C | yes | yes | yes | `problems/19_quantum_chromodynamics/README.md` |
| 20_space_mission_planning | B | yes | yes | yes | `problems/archived/20_space_mission_planning/README.md` |
