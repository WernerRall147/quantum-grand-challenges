...
- Recommended target: rigetti.sim.qvm
- Confidence: medium
- Rationale: Highest weighted score (9.98) from run-history successes (1), smoke successes (1), failures (0), and strategy mode (simulator-first).
- Evidence: score=9.9808, run_history=1, smoke=1, failures=0, global=2
- Simulator target: True
