...
| 03_qae_risk | quantinuum.sim.h2-1sc | medium |
| 04_linear_solvers | quantinuum.sim.h2-1sc | medium |
| 05_qaoa_maxcut | quantinuum.sim.h2-1sc | medium |
...
- Confidence: medium
- Rationale: Highest weighted score (7.00) from run-history successes (1), smoke successes (0), failures (0), and strategy mode (simulator-first).
- Evidence: score=6.9953, run_history=1, smoke=0, failures=0, global=21
- Simulator target: True
- Avg runtime seconds: 0.00
...
- Recommended target: quantinuum.sim.h2-1sc
- Confidence: medium
- Rationale: Highest weighted score (11.99) from run-history successes (2), smoke successes (0), failures (0), and strategy mode (simulator-first).
- Evidence: score=11.9859, run_history=2, smoke=0, failures=0, global=21
- Simulator target: True
- Avg runtime seconds: 0.00
...
- Confidence: medium
- Rationale: Highest weighted score (7.00) from run-history successes (1), smoke successes (0), failures (0), and strategy mode (simulator-first).
- Evidence: score=6.9954, run_history=1, smoke=0, failures=0, global=21
- Simulator target: True
- Avg runtime seconds: 0.00
