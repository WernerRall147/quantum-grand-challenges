...
Correction (2026-09-26): The Q# code is a toy Ising/QUBO same-side energy and contains no protein sequence, lattice walk, self-avoidance, or physical contact-map geometry. The classical script is heuristic knowledge-based contact scoring and is a different model.
