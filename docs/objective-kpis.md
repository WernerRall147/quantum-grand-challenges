...
| 03_qae_risk | C | yes | yes | yes | `problems/03_qae_risk/README.md` |
...
| 06_high_frequency_trading | B | yes | yes | yes | `problems/06_high_frequency_trading/README.md` |
| 07_drug_discovery | B | yes | yes | yes | `problems/07_drug_discovery/README.md` |
| 08_protein_folding | B | yes | yes | yes | `problems/08_protein_folding/README.md` |
| 09_factorization | B | yes | yes | yes | `problems/09_factorization/README.md` |
| 10_post_quantum_cryptography | B | yes | yes | yes | `problems/10_post_quantum_cryptography/README.md` |
| 11_quantum_machine_learning | B | yes | yes | yes | `problems/11_quantum_machine_learning/README.md` |
| 12_quantum_optimization | B | yes | yes | yes | `problems/12_quantum_optimization/README.md` |
| 13_climate_modeling | B | yes | yes | yes | `problems/13_climate_modeling/README.md` |
...
| 19_quantum_chromodynamics | B | yes | yes | yes | `problems/19_quantum_chromodynamics/README.md` |
| 20_space_mission_planning | B | yes | yes | yes | `problems/20_space_mission_planning/README.md` |
