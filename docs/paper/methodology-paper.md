...
> **Revision, 2026-09-27.** A second audit compared the remaining kernels with exact
...
- Re-run the emulator studies for the rewritten QPE, quantum-walk, Shor, QAE, HHL, QAOA and swap-test kernels (Section 8, limitation 8); the noise study was regenerated on 2026-09-27
