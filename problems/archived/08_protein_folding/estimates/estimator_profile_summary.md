# QAOA Toy QUBO (no protein model) Estimator Summary
...
|---|---|---:|---:|---:|---:|---|
| not instance-specific | qubit_gate_ns_e3 + surface_code | 15 | 60,935 | n/a | 0.000733 | `problems/archived/08_protein_folding/circuits/estimate.json` |
