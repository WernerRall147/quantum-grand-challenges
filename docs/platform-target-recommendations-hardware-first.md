...
Generated: 2026-07-02T06:34:20Z
...
| 03_qae_risk | quantinuum.sim.h2-1sc | low |
| 04_linear_solvers | quantinuum.sim.h2-1sc | low |
| 05_qaoa_maxcut | quantinuum.sim.h2-1sc | low |
...
- Confidence: low
- Rationale: Highest weighted score (3.00) from run-history successes (1), smoke successes (0), failures (0), and strategy mode (hardware-first).
- Evidence: score=2.9953, run_history=1, smoke=0, failures=0, global=21
- Simulator target: True
- Avg runtime seconds: 0.00
- Avg queue seconds: 2.85
- Avg cost usd: 0.0000
...
- Recommended target: quantinuum.sim.h2-1sc
- Confidence: medium
- Rationale: Highest weighted score (7.99) from run-history successes (2), smoke successes (0), failures (0), and strategy mode (hardware-first).
- Evidence: score=7.9859, run_history=2, smoke=0, failures=0, global=21
- Simulator target: True
- Avg runtime seconds: 0.00
