...
Quadratic O(√N) Grover speedup is provably optimal but only halves effective key length. AES oracle implementation requires millions of T-gates, dominating total cost. NIST already recommends doubled key sizes.
