...
> **Revision, 2026-09-26.** A second audit compared the remaining kernels with exact
...
> described as one, and one QAOA hardware kernel implemented a different model. The swap-test
...
> the kernels of April 2026. Counting both revisions, 15 of the 20 kernels either did not compute
...
- **HHL (13_climate_modeling)**: on the 2×2 diffusion matrix the post-selected output equals |A⁻¹b|² = [0.8, 0.2] with success probability 5/9, the textbook values for C = 1
