...
- Confidence: low
- Rationale: Highest weighted score (5.00) from run-history successes (1), smoke successes (0), failures (0), and strategy mode (balanced).
- Evidence: score=4.9953, run_history=1, smoke=0, failures=0, global=21
- Simulator target: True
- Avg runtime seconds: 0.00
...
- Recommended target: quantinuum.sim.h2-1sc
- Confidence: medium
- Rationale: Highest weighted score (9.99) from run-history successes (2), smoke successes (0), failures (0), and strategy mode (balanced).
- Evidence: score=9.9859, run_history=2, smoke=0, failures=0, global=21
- Simulator target: True
- Avg runtime seconds: 0.00
