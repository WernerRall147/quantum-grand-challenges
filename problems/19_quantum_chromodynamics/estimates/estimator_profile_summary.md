# Trotter Ising Chain Estimator Summary
...
|---|---|---:|---:|---:|---:|---|
| not instance-specific | qubit_gate_ns_e3 + surface_code | 9 | 54,593 | n/a | 0.000716 | `problems/19_quantum_chromodynamics/circuits/estimate.json` |
